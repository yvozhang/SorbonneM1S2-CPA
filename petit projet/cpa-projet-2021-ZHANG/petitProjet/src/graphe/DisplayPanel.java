...
public class DisplayPanel extends JPanel {
	...
	public void paintComponent(Graphics g) {
		...
		this.g2d.drawString("- 'n' pour lancer calculCercleMin d'algorithme naif ", 15, 60);
		this.g2d.drawString("- 'w' pour lancer calculCercleMin d'algorithme welzl ", 15, 80);
		this.g2d.drawString("- 'h', 'j', 'k', 'l' pour d'éplacer les points", 15, 100);
		...
		for (r = 0; r < this.points.size(); ++r) {
			if ((x = (int) ((Point) this.points.get(r)).getX() + this.xModifier) >= 10
					&& (y = (int) ((Point) this.points.get(r)).getY() + this.yModifier) >= 10) {
